...
class ThumbnailImage extends StatelessWidget {
  ...
  Future<String> getThumbnailFromVideo() async {
    ...
    String url = "https://video-thumbnail-generator-pub.herokuapp.com/generate/thumbnail";
  ...
  static Future<Uint8List> getBytes(String videoUrl) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        //throw 'Could not fetch data from api | Error Code: ${response.statusCode}';
        logHolder.log('Could not fetch data from api | Error Code: ${response.statusCode}',
            level: 6);
        return Uint8List(0);
      }
    } on Exception catch (e) {
      //throw "Error : $e";
      logHolder.log('Error Code: ${e.toString}', level: 6);
      return Uint8List(0);
    }
  }
}
